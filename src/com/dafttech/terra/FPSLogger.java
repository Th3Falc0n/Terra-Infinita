...
public class FPSLogger {
    ...
    public float tick() {
        ...
        if(frameTime > 0.5f) {
            if(outputActive) System.out.println(String.format("FPSCounter: t=%.3f F=%d F/t=%.1f avgF/t=%.1f", frameTime, (int)frameFrames, frameFrames/frameTime, avgFrames/avgTime));
